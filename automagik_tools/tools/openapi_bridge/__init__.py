"""
OpenAPI Bridge - Universal API to MCP Converter
...
from .config import OpenAPIBridgeConfig

# Global config instance
config: Optional[OpenAPIBridgeConfig] = None
...
def get_metadata():
    ...
    return {
        "name": "openapi-bridge",
        "version": "2.0.0",
        "description": "Universal OpenAPI to MCP converter using FastMCP",
...
def get_config_class():
    ...
    return OpenAPIBridgeConfig


def create_server(cfg: Optional[OpenAPIBridgeConfig] = None):
    ...
    mcp = FastMCP.from_openapi(
        ...
        name=config.name or "OpenAPI Bridge",
...
# For backwards compatibility with old automagik tool
def get_server():
