...
from automagik_tools.tools.google_workspace.auth.google_auth import handle_auth_callback, check_client_secrets
from automagik_tools.tools.google_workspace.auth.oauth_config import get_oauth_redirect_uri
